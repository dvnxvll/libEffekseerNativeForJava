...
bool EffekseerEffectCore::Load(const unsigned char *data, int len,
                               float magnification) {
  effect_ = ::Effekseer::Effect::Create(
      EffekseerSettingCore::create().DownCast<Effekseer::Setting>(),
      (void *)data, len, magnification);
  return effect_ != nullptr;
}

const char16_t *
EffekseerEffectCore::GetTexturePath(int32_t index,
                                    EffekseerTextureType type) const {
...
bool EffekseerEffectCore::LoadTexture(char *data, int len, int32_t index,
                                      EffekseerTextureType type) {
  return LoadTexture((const unsigned char *)data, len, index, type);
}

bool EffekseerEffectCore::LoadTexture(const unsigned char *data, int len,
                                      int32_t index,
                                      EffekseerTextureType type) {
  ...
  auto texture =
      loader->Load((const void *)data, len, (Effekseer::TextureType)type, true);
...
bool EffekseerEffectCore::HasTextureLoaded(int32_t index,
                                           EffekseerTextureType type) {
  if (type != EffekseerTextureType::Color)
...
const char16_t *EffekseerEffectCore::GetModelPath(int32_t index) const {
  return effect_->GetModelPath(index);
}

int32_t EffekseerEffectCore::GetModelCount() const {
  return effect_->GetModelCount();
}
...
bool EffekseerEffectCore::LoadModel(const unsigned char *data, int len,
                                    int32_t index) {
...
bool EffekseerEffectCore::HasModelLoaded(int32_t index) {
  return effect_->GetModel(index) != nullptr;
}

const char16_t *EffekseerEffectCore::GetMaterialPath(int32_t index) const {
  return effect_->GetMaterialPath(index);
}

int32_t EffekseerEffectCore::GetMaterialCount() const {
  return effect_->GetMaterialCount();
}

bool EffekseerEffectCore::LoadMaterial(char *data, int len, int32_t index) {
  return LoadMaterial((const unsigned char *)data, len, index);
}

bool EffekseerEffectCore::LoadMaterial(const unsigned char *data, int len,
                                       int32_t index) {
  ...
  auto material =
      loader->Load((const void *)data, len, Effekseer::MaterialFileType::Code);
...
bool EffekseerEffectCore::HasMaterialLoaded(int32_t index) {
  return effect_->GetMaterial(index) != nullptr;
}

const char16_t *EffekseerEffectCore::GetCurvePath(int32_t index) const {
  return effect_->GetCurvePath(index);
}

int32_t EffekseerEffectCore::GetCurveCount() const {
  return effect_->GetCurveCount();
}

bool EffekseerEffectCore::LoadCurve(char *data, int len, int32_t index) {
  return LoadCurve((const unsigned char *)data, len, index);
}

bool EffekseerEffectCore::LoadCurve(const unsigned char *data, int len,
                                    int32_t index) {
...
bool EffekseerEffectCore::HasCurveLoaded(int32_t index) {
  return effect_->GetCurve(index) != nullptr;
}
